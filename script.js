                ...
                if(obj.inc==1){
                    ...
                    if(Math.abs(obj.rotation.x - obj.target.x) <= threshold && Math.abs(obj.rotation.y - obj.target.y) <= threshold && Math.abs(obj.rotation.z - obj.target.z) <= threshold){
                        ...
                        console.log(angka, obj.rotation.x * 180/Math.PI, obj.rotation.y * 180/Math.PI, obj.rotation.z * 180/Math.PI);
                         alert("Pintu ke " + angka + " Sudah Terbuka ! Klik Oke untuk melanjutkan");
                        // swal({
                        //   title: "Good job!",
                        ...
                        // });
                        if(angka==1){
                            window.location = 'pintu1.php';
                        }if(angka==2){
                            window.location = 'pintu2.php';
                        }if(angka==3){
                            window.location = 'pintu3.php';
                        }if(angka==4){
                            window.location = 'pintu4.php';
                        }if(angka==5){
                            window.location = 'pintu5.php';
                        }if(angka==6){
                            window.location = 'pintu6.php';
                        }
